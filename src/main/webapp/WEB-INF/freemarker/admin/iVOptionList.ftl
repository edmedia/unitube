...
<#assign title>List All IVOption</#assign>
<#include "/common/head_1.ftl" />
<script type="text/javascript">
<!--
<#assign message1><@spring.message "delete.select.first"/></#assign>
<#assign message2><@spring.message "delete.confirm.iVOption"/></#assign>
function deleteRecords() {
    ...
    if(deleteConfirm()) {
        document.listForm.action = "iVOptionDelete.do";
...
<#include "custom/*/iVOptionListInside.ftl" />
