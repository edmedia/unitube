...
<#assign title>List All Comment</#assign>
<#include "/common/head_1.ftl" />
<script type="text/javascript">
<!--
<#assign message1><@spring.message "delete.select.first"/></#assign>
<#assign message2><@spring.message "delete.confirm.comment"/></#assign>
function deleteRecords() {
    ...
    if(deleteConfirm()) {
        document.listForm.action = "commentDelete.do";
...
<#include "custom/*/commentListInside.ftl" />
