...
<#assign title>List All AccessRule</#assign>
<#include "/common/head_1.ftl" />
<script type="text/javascript">
<!--
<#assign message1><@spring.message "delete.select.first"/></#assign>
<#assign message2><@spring.message "delete.confirm.accessRule"/></#assign>
function deleteRecords() {
    ...
    if(deleteConfirm()) {
        document.listForm.action = "accessRuleDelete.do";
...
<#include "custom/*/accessRuleListInside.ftl" />
