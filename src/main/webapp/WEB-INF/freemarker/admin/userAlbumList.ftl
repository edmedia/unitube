...
<#assign title>List All UserAlbum</#assign>
<#include "/common/head_1.ftl" />
<script type="text/javascript">
<!--
<#assign message1><@spring.message "delete.select.first"/></#assign>
<#assign message2><@spring.message "delete.confirm.userAlbum"/></#assign>
function deleteRecords() {
    ...
    if(deleteConfirm()) {
        document.listForm.action = "userAlbumDelete.do";
...
<#include "custom/*/userAlbumListInside.ftl" />
