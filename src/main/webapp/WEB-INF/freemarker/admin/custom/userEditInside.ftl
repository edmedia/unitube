...
<form action="${this_url}" name="userForm" method="post" onsubmit="return checkForm(this);">
<#if pageNumber??>
...
<td>
<@spring.bind "user.passWord" />
<input type="password" class="text" name="thePassWord" value="<#if spring.status.value??><#if spring.status.value?is_number>${spring.status.value?c}<#else>${spring.status.value?html}</#if></#if>" />
...
<input type="radio" name="${spring.status.expression}" value="true"<#if spring.status.value??><#if spring.status.value> checked="checked"</#if></#if> /> True
<input type="radio" name="${spring.status.expression}" value="false"<#if spring.status.value??><#if !spring.status.value> checked="checked"</#if></#if> /> False
</td>
<td>
