...
<#assign title>List All Annotation</#assign>
<#include "/common/head_1.ftl" />
<script type="text/javascript">
<!--
<#assign message1><@spring.message "delete.select.first"/></#assign>
<#assign message2><@spring.message "delete.confirm.annotation"/></#assign>
function deleteRecords() {
    ...
    if(deleteConfirm()) {
        document.listForm.action = "annotationDelete.do";
...
<#include "custom/*/annotationListInside.ftl" />
