...
<div class="mediaArea">
    ...
    <p>If you’re uploading it's a good idea to check out our <a href="${baseUrl}/copyright.do">copyright and IP page</a>
        ...
        available to view on the world wide web unless you select the 'Private' option when uploading.</p>
    ...
    <p>You can subscribe to a UniTuba or any one of their albums using RSS. You will need an RSS feed reader installed
        on your computer to do this. Click on the orange icon next to the name of a UniTuba or their album and set a
        notification to alert you by email each time something new is uploaded. </p>
</div>
